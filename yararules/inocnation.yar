rule apt_win32_dll_rat_hiZorRAT
{
	...
	$str3 = { 66 [4-7] 14 40 83 f8 14 7c ?? } // 100017F0
	$str4 = { 66 [4-7] 56 40 83 f8 2d 7c ?? } // 10003621
	$str5 = { 66 [4-7] 20 40 83 f8 1a 7c ?? } // 10003640
	$str6 = { 80 [2-7] 2e 40 3d 50 02 00 00 72 ?? } //  10003930
	$str7 = "%08x%08x%08x%08x" wide ascii
	$str8 = "WinHttpGetIEProxyConfigForCurrentUser" wide ascii
